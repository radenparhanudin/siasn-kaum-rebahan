        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    @endhasanyrole
                    <h5 class="card-title fw-bold mb-0 text-dark"><i class="me-2" data-feather="airplay"></i>Jabatan Fungsional Umum / Pelaksana</h5>
                </div>
                <div class="card-body">
...
@include('components.modal-post', [
    "modalSize"  => "modal-sm",
    "formAction" => route('jfu.download'),
    "modalTitle" => "Download JFU",
    "modalBody"  => view("datareferensi::jfu.form"),
])
@endsection
