<div class="modal fade" id="modalImport" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog {{ $modalSize ?? "" }}" role="document">
        <div class="modal-content">
            <form id="formImport" action="{{ $formAction }}" method="POST">
                ...
                <div class="modal-body m-3">
                    <div class="form-group">
                        <input type="file" name="file_import" id="file_import" class="form-control" placeholder="File Import">
